...
class WhatIsAkiKomi: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        stackViewWidth.constant = scrollWidth * 5.8
        //scrollViewHeight.constant = scrollViewWidth.constant * 0.575
        //changeLanguage((Any).self)
    }
